    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="mb-6 md:mb-0">
                <a href="?view=home" class="flex items-center text-xl font-bold mb-3">
                    EventManager
                </a>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="?view=home" class="text-gray-300 hover:text-white transition">Accueil</a></li>
                    <li><a href="?view=events" class="text-gray-300 hover:text-white transition">Événements</a></li>
                    <?php if ($adminController->isAdmin()): ?>
                        <li><a href="?view=create" class="text-gray-300 hover:text-white transition">Créer un événement</a></li>
                        <li><a href="?view=userList" class="text-gray-300 hover:text-white transition">Liste des utilisateurs</a></li>
                    <?php endif; ?>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition">Équipe</a></li>
